...
def validate_box_entry(box_entry):
    try:
        ...
        # Jeśli dane są poprawne zmieniam kolor pola na zielony
        box_entry.configure(fg_color="green")
        return True
    except ValueError:
        # Jeśli dane są niepoprawne zmieniam kolor pola na czerwony i pokaż błąd
...
def validate_pallet_entry(pallet_entry, max_weight_entry):
    try:
        ...
        # Jeśli dane są poprawne zmieniam kolor pól na zielony
        pallet_entry.configure(fg_color="green")
        max_weight_entry.configure(fg_color="green")
        return True
    except ValueError:
        # Jeśli dane są niepoprawne zmieni sie kolor pól na czerwony i pokaże błąd
